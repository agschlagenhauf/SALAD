...
# Distribution of parameters: separated because of ranges
...
data_params_bet <- data_params_bet %>% rename("Control beta (win)" = bet_win)
data_params_bet <- data_params_bet %>% rename("Control beta (loss)" = bet_loss)
...
mod_pcorrect_plot_1 <- ggscatter(data_physio_behav.nooutlier, x = "bet_win", y = "delta_STCT",
          ...
          cor.method = "pearson",
          xlab = "Beta Win", ylab = "Difference ST-CT") + stat_cor(aes(label = ..p.label..), label.x = 3, p.accuracy = 0.001)
mod_pcorrect_plot_1

mod_pcorrect_plot_2 <- ggscatter(data_physio_behav.nooutlier, x = "bet_loss", y = "delta_STCT",
          add = "reg.line", conf.int = TRUE, 
          cor.method = "pearson",
          xlab = "Beta Loss", ylab = "Difference ST-CT") + stat_cor(aes(label = ..p.label..), label.x = 3, p.accuracy = 0.001)
mod_pcorrect_plot_2

mod_pcorrect_plot_3 <- ggscatter(data_physio_behav.nooutlier, x = "sc_bet_win", y = "delta_STCT",
          add = "reg.line", conf.int = TRUE, 
          cor.method = "pearson",
          xlab = "Scaling Beta Win", ylab = "Difference ST-CT") + stat_cor(aes(label = ..p.label..), label.x = 3, p.accuracy = 0.001)
mod_pcorrect_plot_3

mod_pcorrect_plot_4 <- ggscatter(data_physio_behav.nooutlier, x = "sc_bet_loss", y = "delta_STCT",
          add = "reg.line", conf.int = TRUE, 
          cor.method = "pearson",
          xlab = "Scaling Beta Loss", ylab = "Difference ST-CT") + stat_cor(aes(label = ..p.label..), label.x = 3, p.accuracy = 0.001)
mod_pcorrect_plot_4
