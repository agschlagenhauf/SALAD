...
ggsave(p.betviol, filename = "betviol.png","jpg", "/cloud/project/plots/manuscript_plots")
ggsave(p.alviol, filename = "alviol.png","jpg", "/cloud/project/plots/manuscript_plots")
...
ggsave(mod_pcorrect_plot_7, filename = "fmodpcorrect_winCT_results.png","jpg", "/cloud/project/plots/manuscript_plots")
...
ggsave(mod_pcorrect_plot_8, filename = "fmodpcorrect_lossCT_results.png","jpg", "/cloud/project/plots/manuscript_plots")
...
ggsave(mod_pcorrect_plot_9, filename = "fmodpcorrect_winST_results.png","jpg", "/cloud/project/plots/manuscript_plots")
...
ggsave(mod_pcorrect_plot_10, filename = "fmodpcorrect_lossST_results.png","jpg", "/cloud/project/plots/manuscript_plots")
...
pairedwin.ttest <- stats::t.test(data_params$bet_win,data_params$sc_bet_win, paired = TRUE)
pairedloss.ttest <- stats::t.test(data_params$bet_loss,data_params$sc_bet_loss, paired = TRUE)
