...
longdat.cond.phys$cond2 <- plyr::revalue(longdat.cond.phys$cond, c("aucg_control" = "control","aucg_stress"="stress"))
longdat.cond.phys2$cond2 <- plyr::revalue(longdat.cond.phys2$cond, c("z.peak_cort_control" = "control","z.peak_cort_stress"="stress"))
...
longdat.cond.both <- merge.data.frame(longdat.cond.phys,longdat.cond.correct, by = c("sub_id", "cond2","wm_cap"))
longdat.cond.both2 <- merge.data.frame(longdat.cond.phys2,longdat.cond.correct, by = c("sub_id", "cond2","wm_cap"))
