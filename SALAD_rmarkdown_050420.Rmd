...
if (!require(stringr)) install.packages('gghalves')
...
mod1.AUD.correct <- glmer(Correct~Cond+volat+(1|sub_idx)+school_yrs+age, data=data_new_AUD,family=binomial, nAGQ = 0)
mod2.AUD.correct <- glmer(Correct~Cond*volat+(1|sub_idx)+school_yrs+age, data=data_new_AUD,family=binomial, nAGQ = 0)
...
mod2.AUD.wstay <- glmer(w_stay~Cond*volat+(1|sub_idx)+school_yrs+age, data=data_new_AUD,family=binomial, nAGQ = 0)
...
mod2.correct <- glmer(Correct~Group*Cond+Group*volat+Cond*volat+(1|sub_idx)+school_yrs, data=data_new,family=binomial, nAGQ = 0)
