...
# compare model with intercept only and random intercept to verify that hierarchical modeling makes sense
interceptOnly <- gls(p_correct ~ 1,data = longdat.correct, method = "ML")
randomInterceptOnly <- lme(p_correct ~1, data = longdat.correct, random = ~1|sub_id, method = "ML")
mod1 <- glmer()
