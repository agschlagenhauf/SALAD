...
mod2.HC.correct <- glmer(Correct~Cond*volat+(1|sub_idx)+school_yrs+age, data=data_new_HC,family=binomial, nAGQ = 0)
...
mod1.HC.lswitch <- glmer(l_switch~Cond+volat+(1|sub_idx)+school_yrs+age, data=data_new_HC,family=binomial, nAGQ = 0)
mod2.HC.lswitch <- glmer(l_switch~Cond*volat+(1|sub_idx)+school_yrs+age, data=data_new_HC,family=binomial, nAGQ = 0)
...
mod1.correct <- glmer(Correct~Group+Cond+volat+(1|sub_idx)+school_yrs+age, data=data_new,family=binomial, nAGQ = 0)
mod2.correct <- glmer(Correct~Group*Cond+Group*volat+Cond*volat+(1|sub_idx)+school_yrs+age, data=data_new,family=binomial, nAGQ = 0)
mod3.correct <- glmer(Correct~Group*Cond*volat+(1|sub_idx)+school_yrs+age, data=data_new,family=binomial, nAGQ = 0)
...
mod2.lswitch <- glmer(l_switch~Group*Cond+Group*volat+Cond*volat+(1|sub_idx)+school_yrs+age, data=data_new,family=binomial, nAGQ = 0)
mod3.lswitch <- glmer(l_switch~Group*Cond*volat+(1|sub_idx)+school_yrs+age, data=data_new,family=binomial, nAGQ = 0)

# model comparison of lswitch models
anova(mod0.lswitch,mod0a.lswitch,mod1.lswitch,mod2.lswitch,mod3.lswitch)
...
emmip(mod2.correct, volat ~ Group | Cond)

emmip(mod3.wstay, volat ~ Cond | Group)
emmip(mod2.wstay, volat ~ Group | Cond)

emmip(mod3.lswitch, volat ~ Cond | Group)
emmip(mod2.lswitch, volat ~ Group | Cond)

correct.emm <- emmeans(mod2.correct,pairwise ~ Group | c(Cond,volat))
