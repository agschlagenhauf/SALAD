...
OR_correct <- sjPlot::plot_model(mod1.HC.cond.correct,show.values=TRUE, show.p=TRUE, title = "Odd's Ratio of fixed-effects model", axis.labels = c("Stable Phase","Reversal Phase","Condition Effect"))

png(filename="OR_correct.png")  
