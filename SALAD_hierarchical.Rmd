...
sjPlot::tab_model(mod2.HC.cond.RT, 
                  show.re.var = TRUE, 
                  pred.labels = TRUE) #c("Intercept", "Condition (Stress Day)", "Reversal Phase", "Stable Phase"))

sjPlot::plot_model(mod2.HC.RT,show.values=TRUE, show.p=TRUE, axis.labels = c("Condition*Stable","Condition*Reversal","Reversal Phase","Stable Phase","Cortisol Effect"))
...
emmip(mod2.HC.cond.RT, Cond ~ volat)
