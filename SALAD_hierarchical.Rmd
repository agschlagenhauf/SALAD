...
mod3.HC.cond.correct <-glmer(Correct~(1|sub_idx)+(Cond|sub_idx)+volat, data=data_new_HC,family=binomial)
mod4.HC.cond.correct <-glmer(Correct~(1|sub_idx)+Cond+(volat|sub_idx), data=data_new_HC,family=binomial)
mod5.HC.cond.correct <-glmer(Correct~(1|sub_idx)+(Cond|sub_idx)+(volat|sub_idx), data=data_new_HC,family=binomial)
mod6.HC.cond.correct <-glmer(Correct~(1|sub_idx)+(Cond|sub_idx)*(volat|sub_idx), data=data_new_HC,family=binomial)
