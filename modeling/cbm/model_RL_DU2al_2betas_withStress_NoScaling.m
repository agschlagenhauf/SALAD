function [loglik, traj] = model_RL_DU2al_2betas_withStress_NoScaling(parameters,subj)
...
% betas
nd_beta_win  = parameters(end-1); % beta_win
beta_win     = exp(nd_beta_win);  

nd_beta_loss  = parameters(end); %beta_loss
