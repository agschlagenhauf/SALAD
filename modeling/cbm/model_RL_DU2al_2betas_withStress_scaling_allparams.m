function [loglik, traj] = model_RL_DU2al_2betas_withStress_scaling_allparams(parameters,subj)
...
scaling_alpha2_stress  = parameters(6);         % normally-distributed alpha
...
alpha_stress      = [alpha1_stress, alpha2_stress];


% determine kappa_stress
% scaling_kappa  = parameters(8);
