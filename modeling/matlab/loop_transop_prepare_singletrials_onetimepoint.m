...
table(substart:subend,:) = [sub_idx', sub_group', trial_idx', outcome(:,sub), response(:,sub), correct(:,sub), winstay(:,sub), loseshift(:,sub), reaction_times(:,sub)];
...
var_names ={'sub_idx', 'Group', 'Trial_idx', 'Outcome', 'Choice_t','Correct', 'win_st','lose_sh', 'RT'};
